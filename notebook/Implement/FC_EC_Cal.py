...
#     print(indices)
    ...
    conn = spectral_connectivity_epochs(
            ...
            fmin=8, fmax=13, faverage=True, verbose=False).get_data()[:, 0]
    conn = conn.tolist()
    return conn
...
if __name__ == "__main__":
    ...
    for i, d in enumerate(tqdm(EEG_epoches)):
        ...
        np.save('/workspace/brail_poc3/experiments/FC_Result_alpha/{}/{}.npy'.format(metric_Name, EEG[i]['Subject_Number']), FC)
